                                  ...
                                  <div class="dashboard-header-area">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{route('admin-video-index')}}" class="title-stats title-blue">
                                                <div class="icon"><i class="fa fa-newspaper-o fa-5x"></i></div>
                                                <div class="number">{{count($uvideos)}}</div>
                                                <h4>Total Uploaded Videos!</h4>
                                                <span class="title-view-btn">View All</span>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{route('admin-fetch-index')}}" class="title-stats title-green">
                                                <div class="icon"><i class="fa fa-sitemap fa-5x"></i></div>
                                                <div class="number">{{count($fvideos)}}</div>
                                                <h4>Total Fetched Videos!</h4>
                                                <span class="title-view-btn">View All</span>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{route('admin-cat-index')}}" class="title-stats title-gray">
