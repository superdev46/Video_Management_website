                                    ...
                                    <div class="add-product-box">
                                        ...
                                        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                          ...
                                          {{csrf_field()}}
                                            ...
                                            <div class="col-sm-2">
                                              <img width="130px" height="90px" id="adminimg" src="{{ Auth::guard('admin')->user()->photo ? asset('assets/files/images/'.Auth::guard('admin')->user()->photo):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="">
                                          </div>
                                          <div class="col-sm-4">
