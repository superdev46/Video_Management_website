...
<style type="text/css">
  #loader {
    background: url("{{asset('assets/admin/img/fileloader.gif')}}") no-repeat  center #FFF;
    position: fixed;
    height: 100%;
    width: 80%;
    z-index: 9999;
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="add-product-box">
                                        ...
                                        <hr>
                                        <form id="frmsubmit" class="form-horizontal" action="{{route('admin-video-update',$video->id)}}" method="POST" enctype="multipart/form-data">
