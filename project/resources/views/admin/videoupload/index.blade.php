                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <div class="add-product-box">
                                      <div class="add-product-header products">
                                          <h2>Video Upload Section</h2>
                                          <a href="{{route('admin-video-create')}}" class="btn add-newProduct-btn"><i class="fa fa-plus"></i> Create New Video</a>  
                                      </div>
                                      <hr>
                  <div>
                                              ...
                                              <tr role="row" class="odd">
                                                    ...
                                                    <td>{{$video->category->cat_name}}</td>
                                                      <td>
                                                        ...
                                                        <a href="{{route('admin-video-s',['id1'=>$video->id,'id2'=>0])}}" class="btn btn-warning product-btn"><i class="fa fa-times"></i> Remove Top</a>
                                                        @else        

                                                        <a href="{{route('admin-video-s',['id1'=>$video->id,'id2'=>1])}}" class="btn btn-success product-btn"><i class="fa fa-times"></i> Make Top</a>
                                                        @endif
                                                        <a href="{{route('admin-video-edit',$video->id)}}" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> Edit</a>
                                                        <a href="{{route('admin-video-delete',$video->id)}}" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                      </td>
                                                  </tr>
                                                  @endforeach
                                                  </tbody>
