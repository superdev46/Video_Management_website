                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default general-setting">
                            <div class="panel-heading">
                                <i class="fa fa-upload"></i> Create Playlist
                                <a href="{{route('user-playlist-index')}}" style="float: right; color: white;"><i class="fa fa-arrow-left"></i> Back</a>
                            </div>
                            <div class="panel-body">

                                        <form class="form-horizontal" action="{{route('user-playlist-create')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="file" id="uploadImageFile" class="hidden" name="photo" value="">
                                          ...
                                          <input type="hidden" name="user_id" value="{{Auth::guard('user')->user()->id}}">
                                            ...
                                            <div class="add-product-footer">
                                                <button name="addProduct_btn" type="submit" class="btn add-product_btn">Create Playlist</button>
                                            </div>
                                        </form>
                            </div>
                        </div>
