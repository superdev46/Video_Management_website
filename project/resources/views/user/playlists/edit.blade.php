                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default general-setting">
                            <div class="panel-heading">
                                <i class="fa fa-upload"></i> Edit Playlist
                                <a href="{{route('user-playlist-index')}}" style="float: right; color: white;"><i class="fa fa-arrow-left"></i> Back</a>
                            </div>
                            <div class="panel-body">

                                        <form class="form-horizontal" action="{{route('user-playlist-edit',$playlist->id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              ...
                                              <img width="130px" height="90px" id="adminimg" src="{{ $playlist->photo ? asset('assets/files/images/'.$playlist->photo):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="" id="adminimg">
                                            </div>
                                          </div>
                                    ...
                                    <input type="file" id="uploadImageFile" class="hidden" name="photo" value="">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="title" id="edit_title" placeholder="Enter Title " required="" type="text" value="{{$playlist->title}}">
                                            </div>
                                          </div>
                                          ...
                                          <input type="hidden" name="user_id" value="{{Auth::guard('user')->user()->id}}">
                                            ...
                                            <div class="add-product-footer">
                                                <button name="addProduct_btn" type="submit" class="btn add-product_btn">Update Playlist</button>
                                            </div>
                                        </form>
                            </div>
                        </div>
