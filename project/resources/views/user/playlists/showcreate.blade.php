                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default general-setting">
                            <div class="panel-heading">
                                <i class="fa fa-upload"></i> Add Video To Playlist
                                <a href="{{route('user-playlist-show',$playlist->id)}}" style="float: right; color: white;"><i class="fa fa-arrow-left"></i> Back</a>
                            </div>
                            <div class="panel-body">

                                        <form class="form-horizontal" action="{{route('user-playlist-show-create-store',$playlist->id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              ...
                                              <img width="450px" height="350px" id="adminimg" src="" alt="" id="adminimg">
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              ...
                                              <option value="{{$video->id}}">{{substr($video->title,0,50)}}</option>
                                              @endforeach
                                            </select>
                                            </div>
                                          </div>
