...
<div id="loader"></div>
                    <div class="row">
                        ...
                        <div class="panel panel-default general-setting">
                            <div class="panel-heading">
                                ...
                                <a href="{{route('user-fetch-index')}}" style="color: white; margin-left: 820px;"><i class="fa fa-arrow-left"></i> Back</a> 
                            </div>
                            <div class="panel-body">
                                          <form class="form-horizontal" action="{{route('user-fetch-editfetch',$video->id)}}" method="POST">
                                 @include('includes.form-success')
                                        ...
                                        <hr>
                                        <form class="form-horizontal" action="{{route('user-fetch-update',$video->id)}}" method="POST" enctype="multipart/form-data">
      ...
      <!-- If the link has youtube then execute this script -->
              @if($link == "youtube")
                                  ...
                                  <iframe width="494" height="345" src="https://www.youtube.com/embed/{{$id}}" allowfullscreen>
                                  </iframe>
                                            </div>
                                          </div>
  ...
  <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                    <input type="hidden" id="uploadVideoFile" class="hidden" name="url" value="{{$url}}">
<iframe  width="494" height="345" src="https://www.dailymotion.com/embed/video/{{$id}}" allowfullscreen></iframe>
                                            </div>
                                          </div>
  ...
  <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                    <input type="hidden" id="uploadVideoFile" class="hidden" name="url" value="{{$url}}">
                                      <iframe width="494" height="345" src="https://player.vimeo.com/video/{{$id}}" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                            </div>
                                          </div>
